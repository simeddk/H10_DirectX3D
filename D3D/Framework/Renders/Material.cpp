...
{
	colorDesc.Ambient = Color(r, g, b, a);
}
...
{
	colorDesc.Diffuse = Color(r, g, b, a);
}
...
{
	colorDesc.Specular = Color(r, g, b, a);
}
...
{
	colorDesc.Emissive = Color(r, g, b, a);
}
...
void Material::DiffuseMap(string file)
{
	...
	diffuseMap = new Texture(String::ToWString(file));
}
...
void Material::SpecularMap(string file)
{
	...
	specularMap = new Texture(String::ToWString(file));
}
...
void Material::NormalMap(string file)
{
	...
	normalMap = new Texture(String::ToWString(file));
}
